...
```javascript
fromBinaryStringUint32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-from-binary-string@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-from-binary-string@v0.2.3-umd/browser.js"></script>
```
